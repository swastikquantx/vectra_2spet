...
try {
  eval(qXReplacement);
  console.log("qX ok");
} catch(e) { console.error("qX", e); }

try {
  eval(vectraReplacement);
  console.log("vectra ok");
} catch(e) { console.error("vectra", e); }

try {
  eval(spectreReplacement);
  console.log("spectre ok");
} catch(e) { console.error("spectre", e); }
